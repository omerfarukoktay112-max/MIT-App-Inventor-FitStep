...
* **Platform:** Android
* **Development:** MIT App Inventor (Block-based Logic)
* **Storage:** TinyDB (Local Key-Value Database)
* **Core Systems:** Sensor Integration, Time-based Algorithms, and Persistent State Management.
...
1.  Download the `FitStep.aia` from the `src/` folder.
2.  Import the file into the [MIT App Inventor](http://ai2.appinventor.mit.edu/) environment.
3.  To test on your device, you can use the `.apk` file located in the `build/` folder.

## 🌐 Roadmap
* [ ] GPS-based route tracking for outdoor activities.
* [ ] Multi-language support (English/Turkish localization).
* [ ] Advanced graphical analysis for weekly/monthly progress.

---

## 👤 Author
* **Ömer Faruk OKTAY** - [GitHub Profile](https://github.com/omerfarukoktay112-max)

---
*Built with passion for healthy living and mobile innovation.*
